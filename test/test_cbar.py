...
class TestCBar(unittest.TestCase):
    def setUp(self, no_gpu=True):
        self.kwargs_list = [{'pad': 20, 'pad_color': 'w'}, {'pad': 20, 'pad_color': 'none'}, {'x': .1}, {'y': .7},
                            {'width': .1}, {'length': .4}, {'label': 'Bar'}, {'ticks': {.14: 'pi-3'}}, {'ticks': [.14]},
                            {'fontsize': 15}, {'linecolor': 'gray'}, {'linewidth': 4}, {'tick_len': 4}]
        self.cmaps = ['gray', 'hsv']
